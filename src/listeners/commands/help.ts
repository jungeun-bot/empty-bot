          ...
          { type: 'divider' },
          {
            ...
            text: {
              ...
              text: [
                ...
                '',
                '*`/설치`*',
                '현재 채널에 예약하기·수정/취소·신고·📊 현황 버튼이 포함된 예약 패널을 설치하고 고정합니다. (채널 관리자용)',
                '',
                '*`/사용방법`*',
                '지금 보고 있는 이 도움말을 표시합니다.',
                '',
                '*`/정기회의`*',
                '매주·격주·매일·매월 반복되는 정기 회의를 예약합니다. 반복 종료일과 참석자를 지정할 수 있습니다.',
                '',
                '*`📊 현황`* (설치 패널 버튼)',
                '예약 패널의 📊 현황 버튼을 클릭하여 날짜·회의실별 예약 현황을 한눈에 조회합니다.'
              ].join('\n'),
            },
          },
          { type: 'divider' },
